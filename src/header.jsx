...
return (
  <header className="max-w-[1440px] mx-auto flex items-center justify-between">
    <div className="h-[170px] flex items-center">
      <img className=" w-[160px] h-[160px] rounded-[50%]" src="./src/imgs/4a171f2bfd2e242c8f60da4f4a857c2f-removebg-preview.png"  />
    </div>
    ...
    <div>
      <select className="text-[white] bg-[#ffffff00] text-[23px]">
